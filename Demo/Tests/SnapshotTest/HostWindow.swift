...
public class HostWindow: UIWindow {
    ...
    init(presentation: Presentation) {
        ...
        presentation.mask?.frame = presentation.size.asRect
            ...
            public enum X {
                public static var portrait: Presentation {
                    return Presentation(
                        ...
                        traitCollection: UITraitCollection(arrayLiteral: 
                            [UITraitCollection.interfaceIdiom.phone, UITraitCollection.layoutDirection.leftToRight]),
...
//                        traitCollection: UITraitCollection.iPhone.iPhoneRegular.landscape,
...
//                        traitCollection: UITraitCollection.iPhone.iPhonePlus.landscape,
//                        mask: nil)
//                }
//            }
...
//                        traitCollection: UITraitCollection.iPad.regular)
//
...
//                        traitCollection: UITraitCollection.iPad.splitHalf)// [idiom.pad, vertical.regular, horizontal.regulat, scale.3]
//
//                    public static let twoThird = Presentation(
...
//        }
        ...
        private init(name: String, size: CGSize, traitCollection: SubTraitCollection, mask: UIView? = nil){
            self.name = name
            self.size = size
